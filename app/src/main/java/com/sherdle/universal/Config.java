...
public class Config {
    ...
    public static final String CONFIG_URL = "https://marketingproafiliado.com.br/config.json";
    ...
    public static final boolean TABLET_LAYOUT = false;
    ...
    public static final boolean WP_CHIPS = false;
    ...
    public static final String NOTIFICATION_BASEURL = "marketingproafiliado.com.br";

    //Use large row layout
    public static final int RSS_ROW_MODE = ViewModeUtils.NORMAL;

    //Show category chips in WooCommerce
    public static final boolean WC_CHIPS = false;
    ...
    public static final String[] OPEN_OUTSIDE_WEBVIEW = new String[]{"market://", "youtube.com", "youtube.com.br", "instagram.com", "play.google.com", "plus.google.com", "mailto:", "tel:", "vid:", "geo:", "whatsapp:", "sms:", "intent://"};
